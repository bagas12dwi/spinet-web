            ...
            <div class="row d-flex align-items-center justify-content-center">
                <div class="col-6 col-md-6 col-sm-12">
                    <div class="container p-4">
                        <h1 class="text-primary mb-5 fw-bold" style="font-size: 5em">Modul Ajar</h1>
                        <h5 class="text-primary"><span class="text-warning">Dirancang untuk memenuhi kebutuhan persiapan
                                pembelajaran yang anda butuhkan </span>sesuai dengan kurikulum fisika <span
                                class="text-warning"> anda.</span>
                        </h5>
                    </div>
                </div>
                <div class="col-6 col-md-6 col-sm-12">
                ...
                <div class="row me-5">
                    ...
                    <div class="col-6 justify-self-start">
                        <div class="container bg-warning d-flex align-items-center justify-content-center"
                            ...
                            <h5 class="fw-bold">Modul Ajar Sesuai Kebutuhan</h5>
                        </div>
                    </div>
                </div>
                <div class="row align-items-end me-5 mt-4">
                    <div class="col-6">
                        <div class="container bg-warning d-flex align-items-center justify-content-center"
                            ...
                            <h5 class="fw-bold">Panduan Terstruktur</h5>
                        </div>
                    </div>
                    <div class="col-6 justify-self-start">
                        <div class="container bg-warning d-flex align-items-center justify-content-center"
                            style="height: 15em; border-radius: 0px 3em 3em 0px;-webkit-border-radius: 0px 3em 3em 0px;-moz-border-radius: 0px 3em 3em 0px;">
                            <h5 class="fw-bold">Penerapkan konsep menarik</h5>
                        </div>
                    </div>
                </div>
            </div>
